				...
				<fieldset style="border-color: red">
					...
					<div align="left">
						...
						Date of Birth: <br> <input type="date" name="date"
							placeholder="mm/dd/yyyy"><br> <br> 
							Pan:<br><input type="text" name="pan" placeholder="eg. ABCD1234" pattern = "[A-Za-z]{4}[0-9]{4,}"><br>
						Employee Type<br> <input type="text" name = "emptype" placeholder="Employee Type"> 
