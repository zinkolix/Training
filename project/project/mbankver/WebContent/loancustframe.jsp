...
<jsp:include page="banner.jsp" />
	...
	<table>
		<tr id="nav">
			...
			<a href="loan/report.do?view=html" target="myFrame">Report Html</a> <br><br><hr>
			<a href="loan/report.do?view=pdf" target="myFrame">Report Pdf</a> <br><br><hr>
		</td>
